          ...
          <div className="container mx-auto px-4 max-w-6xl grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="lg:col-span-1 card-elevated">
              <CardContent className="p-6">
                ...
                <p className="font-semibold">{trackingData.expectedDeliveryDate}</p>

                <p className="text-sm text-muted-foreground mt-2">Shipper</p>
                <p>{trackingData.shipperName}</p>
                <p className="text-sm text-muted-foreground">Address</p>
                <p>{trackingData.shipperAddress}</p>

                <p className="text-sm text-muted-foreground mt-2">Receiver</p>
                ...
                <div className="mt-6 text-center">
                  <a
                    href={`https://shipping-backend-x7fl.onrender.com/tracking/${trackingData.trackingNumber}/pdf`}
                    target="_blank"
